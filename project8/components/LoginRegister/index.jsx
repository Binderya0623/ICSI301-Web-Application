      ...
      <Grid container justify="center" spacing={4} style={{ padding: "0px" }}>
        <Grid item xs={12} sm={6}>
          <Paper elevation={3} style={{ padding: "20px", paddingTop: "0px", paddingBottom: "10px", backgroundColor: "#fff" }}>
            <Typography variant="h6" color="#92c5d1" gutterBottom>
              Нэвтрэх бол:
            </Typography>
            <form onSubmit={this.handleLoginSubmit}>
              ...
              <Button
                ...
                variant="contained"
                color="primary"
                style={{ marginTop: "5px", backgroundColor: "#92c5d1" }}
              >
                Нэвтрэх
              </Button>
              {this.state.loginMessage && (
                <Typography style={{ color: "#92c5d1", marginTop: "5px" }}>
                  {this.state.loginMessage}
                </Typography>
              )}
            </form>
          ...
          <Paper elevation={3} style={{ padding: "20px", paddingTop: "0px", paddingBottom: "10px",backgroundColor: "#fff" }}>
            ...
            <form onSubmit={this.handleRegisterSubmit}>
              ...
              {this.state.regMessage && (
                <Typography style={{ color: this.state.regMessage.includes("амжилттай") ? "#52b2cf" : "#92c5d1", marginTop: "5px" }}>
                  {this.state.regMessage}
                </Typography>
              )}
            </form>
