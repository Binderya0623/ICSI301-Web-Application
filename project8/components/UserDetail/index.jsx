    ...
    return (
      <Grid container spacing={3}>
        <Grid item xs={12}>
          ...
          <Typography variant="h6" gutterBottom style={{ color: "#92c5d1" }}>
        ...
        <Grid item xs={12}>
          <Button
            ...
            component={Link}
            variant="contained"
            style={{ backgroundColor: "#92c5d1", color: "#fff" }}
          >
            Зураг харах
          </Button>
        </Grid>
        ...
        <Grid item xs={12}>
          <Typography variant="h6" style={{ color: "#92c5d1" }}>
            {user.first_name} хэрэглэгчийг дурдсан зурагнууд:
          </Typography>
                  ...
                  title={
                    (
                      <Link
                        ...
                        style={{ textDecoration: "none", color: "#92c5d1" }}
                      >
          ...
          <Grid item xs={6} md={6}>
            ...
            >
              <CardActionArea component={Link} to={`/photos/${user._id}`}>
                ...
                />
                <CardContent>
                  <Typography variant="h6" color="#92c5d1">
